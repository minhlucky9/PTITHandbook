...
namespace DS.Inspectors
{
    ...
    public class DSInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            string dialogueFolderPath = $"Assets/Resources/DialogSystem/Dialogues/{currentDialogueContainer.FileName}";
        ...
        private void DrawDialogueGroupArea(DSDialogueContainerSO dialogueContainer, List<string> dialogueGroupNames)
        {
            ...
            DSDialogueGroupSO selectedDialogueGroup = DSIOUtility.LoadAsset<DSDialogueGroupSO>($"Assets/Resources/DialogSystem/Dialogues/{dialogueContainer.FileName}/Groups/{selectedDialogueGroupName}", selectedDialogueGroupName);
