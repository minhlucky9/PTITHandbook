...
namespace DS.Utilities
{
    ...
    public static class DSIOUtility
    {
        ...
        public static void Initialize(DSGraphView dsGraphView, string graphName)
        {
            ...
            containerFolderPath = $"Assets/Resources/DialogSystem/Dialogues/{graphName}";
        ...
        private static void SaveNodeToGraph(DSNode node, DSGraphSaveDataSO graphData)
        {
            ...
            DSNodeSaveData nodeData = new DSNodeSaveData()
            {
                ...
                ExecutedFunction = node.ExecutedFunction,
                NextExecutedFunction = node.NextExecutedFunction
            };
        ...
        private static void CreateDefaultFolders()
        {
            ...
            CreateFolder("Assets/Resources/DialogSystem", "Dialogues");

            CreateFolder("Assets/Resources/DialogSystem/Dialogues", graphFileName);
