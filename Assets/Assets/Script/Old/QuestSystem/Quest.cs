...
public class Quest
{
    ...
    public void InstantiateCurrentQuestStep(Transform parentTransform)
    {
        ...
        {
            // Clone object with world position and rotation
            QuestStep questStep = Object.Instantiate<GameObject>(
                questStepPrefab,
                questStepPrefab.transform.position, // gi? nguyên v? trí ban ??u c?a prefab
                questStepPrefab.transform.rotation  // gi? nguyên h??ng ban ??u c?a prefab
            ).GetComponent<QuestStep>();

            // Set the parent after instantiation
            questStep.transform.SetParent(parentTransform, worldPositionStays: true);
