...
public class EnvironmentsVisual : MonoBehaviour
{
    ...
    public void SetDebug(bool value)
    {
        ...
        {
          //  UIManager.instance.Slider_daytime.value = DateTime.Now.Hour;
        }
    }
    ...
    IEnumerator updateTime()
    {
        if (!isOnDebug)
        {
           ...
           // UIManager.instance.SetTextTime(currentTime.ToString("HH:mm"), currentTime.ToString("dd-MM-yyyy"));
        ...
        using (UnityWebRequest request = UnityWebRequest.Get(url))
        {
            ...
            else
            {
                ...
                if (weatherData != null)
                {
                  ...
                  //  UIManager.instance.SetTextWeather(weatherData.main.temp + "<sup>o</sup>C", description);
                }
                else
                {
