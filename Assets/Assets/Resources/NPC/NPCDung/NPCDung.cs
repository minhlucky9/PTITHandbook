...
public class NPCDung : TalkInteraction, IDialogueHandler
{
    [Header("NPC infos")]
          ...
          .OnStateChanged += () =>
          {
              ...
              switch (state)
              {
                  case QuestState.IN_PROGRESS:
                      groupName = "BanPhaoINPROGRESS";
                      break;
                  case QuestState.FINISHED:
                      groupName = "BanPhaoNotQuest";
                      break;
                  default:
                      groupName = "BanPhaoNotQuest";
                      break;
    ...
    public override void Interact()
    {
        base.Interact();
          ...
          if (QuestManager.instance.questMap[questConversation.id].state == QuestState.IN_PROGRESS && quizConversation == null &&
                QuestManager.instance.questMap[questConversation.id].info.questType != QuestInfoSO.QuestType.Quiz)
        {
            ...
            {
                if (groupEntry.Key.GroupName == "BanPhaoINPROGRESS")
                {
